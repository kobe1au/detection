...
def full_alignment(fixed: bool = True) -> dict:
    gate = fixed_gate() if fixed else learned_gate(quality=True, uncertainty=True, time=True)
    return merge(
        {
            "model": {
                "fusion_mode": "ours",
...
def build_configs() -> tuple[dict[str, dict], dict[str, list[str]]]:
    ...
    gate_variants = [
        ...
        ("I3_01_learned_no_signals.yaml", "I3_01_learned_no_signals", learned_gate(quality=False, uncertainty=False, time=False)),
        ("I3_02_quality_only.yaml", "I3_02_quality_only", learned_gate(quality=True, uncertainty=False, time=False)),
        ("I3_03_uncertainty_only.yaml", "I3_03_uncertainty_only", learned_gate(quality=False, uncertainty=True, time=False)),
        ("I3_04_time_drift_only.yaml", "I3_04_time_drift_only", learned_gate(quality=False, uncertainty=False, time=True)),
        ("I3_05_full_gate.yaml", "I3_05_full_gate", learned_gate(quality=True, uncertainty=True, time=True)),
    ]
